...
save_round = 1
seeds = 123456
model_prefix_load = 'RE3_peak_base{}'.format(weights_round) #False
model_prefix_save = 'RE3_peak_base{}'.format(save_round)
N_vars = L_vars = 15
lr = 1e-5
# ==================== #
...
model_final = keras.Model(inputs=IN, outputs=OUT)
