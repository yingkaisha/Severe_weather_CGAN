...
save_round = 3
seeds = 123456
model_de_load = 'GAN_de{}_skew'.format(weights_round) #False
model_gen_load = 'GAN_gen{}_skew'.format(weights_round) #False

model_de_save = 'GAN_de{}_skew'.format(save_round) #False
model_gen_save = 'GAN_gen{}_skew'.format(save_round) #False

lr = 1e-4
loss_weight = 1e-1
std_noise = 0.5
non_neg = True
output_flag = output_skew_flag
