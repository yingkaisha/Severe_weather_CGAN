...
W_old = k_utils.dummy_loader('/glade/work/ksha/NCAR/Keras_models/mlp_lead{}'.format(lead_name))
...
np.save('{}RESULT_mlp_lead{}_mlp.npy'.format(filepath_vec, lead_name), save_dict)
print('{}RESULT_mlp_lead{}_mlp.npy'.format(filepath_vec, lead_name))
