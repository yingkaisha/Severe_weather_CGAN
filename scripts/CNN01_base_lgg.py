...
save_round = 1
seeds = 123456
model_prefix_load = 'RE3_smooth_lgg{}'.format(weights_round) #False
model_prefix_save = 'RE3_smooth_lgg{}'.format(save_round)
N_vars = L_vars = 15
lr = 1e-4
# ==================== #
...
model_base = mu.create_model_lgg(input_shape=(64, 64, 15), channels=[96, 96, 128, 128])
