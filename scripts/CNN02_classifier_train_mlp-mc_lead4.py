...
indx_valid_v4x, indy_valid_v4x, day_valid_v4x, lead_valid_v4x = filename_to_loc(filename_valid3_pick_v4x)
...
indx_valid_v4, indy_valid_v4, day_valid_v4, lead_valid_v4 = filename_to_loc(filename_valid3_pick)
...
VALID_VEC_pick = VALID_VEC#[ind_pick, ...]
VALID_stn_pick = VALID_stn#[ind_pick, :]
VALID_Y_pick = VALID_Y#[ind_pick]
VALID_Y_adjust_pick = VALID_Y_v4_adjust #[ind_pick]
