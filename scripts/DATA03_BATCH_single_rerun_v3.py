...
# VALID_day630_neg_neg_neg_indx27_indy33_lead10.npy
# VALID_day656_neg_neg_neg_indx28_indy66_lead11.npy
# VALID_day626_neg_neg_neg_indx22_indy36_lead12.npy
# TRAIN_day552_neg_neg_neg_indx43_indy33_lead6.npy
# TRAIN_day538_neg_neg_neg_indx13_indy48_lead7.npy
# TRAIN_day548_neg_neg_neg_indx34_indy25_lead8.npy

# TRAIN_day481_neg_neg_neg_indx44_indy45_lead19.npy
# TRAIN_day597_neg_neg_neg_indx14_indy68_lead17.npy
# TRAIN_day584_neg_neg_neg_indx23_indy57_lead15.npy

# TRAIN_day586_neg_neg_neg_indx37_indy25_lead16.npy
# VALID_day602_neg_neg_neg_indx33_indy68_lead23.npy
...
HRRRv3_lead = da.from_zarr(save_dir_campaign+'HRRR_{:02}_v3.zarr'.format(lead))
print('... done')
...
batch_dir = path_batch_v3 #'/glade/campaign/cisl/aiml/ksha/NCAR_batch_v3/'
...
#L_train = 3
for day in range(day_p, day_p+1):
    if day > 600:
        tv_label = 'VALID'
    else:
        tv_label = 'TRAIN'
        
    for ix in range(indx_p, indx_p+1):#shape_80km[0]):
        for iy in range(indy_p, indy_p+1):#shape_80km[1]):
