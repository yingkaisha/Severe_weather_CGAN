...
indx_train_v3, indy_train_v3, day_train_v3, lead_train_v3 = filename_to_loc(filename_train1_pick_v3)
...
indx_train_v4x, indy_train_v4x, day_train_v4x, lead_train_v4x = filename_to_loc(filename_train1_pick_v4x)
...
indx_valid_v3, indy_valid_v3, day_valid_v3, lead_valid_v3 = filename_to_loc(filename_valid1_pick_v3)
...
indx_valid_v4x, indy_valid_v4x, day_valid_v4x, lead_valid_v4x = filename_to_loc(filename_valid1_pick_v4x)
...
indx_valid_v4, indy_valid_v4, day_valid_v4, lead_valid_v4 = filename_to_loc(filename_valid1_pick)
