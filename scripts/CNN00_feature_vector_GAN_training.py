'''
Compute CGAN outputs for the training set samples.
'''
...
filename_valid = filename_valid[3910:3930]
...
for i, name in enumerate(filename_valid):
    ...
    output_skew = model_gen_skew.predict([input_skew+noise_skew, input_ref])
