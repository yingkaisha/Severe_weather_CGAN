'''
CGAN training script for environmental predictors (MSLP, T2, RH, etc)
'''
...
save_round = 3
seeds = 789 #123456
model_de_load = 'GAN_de{}_norm'.format(weights_round) #False
model_gen_load = 'GAN_gen{}_norm'.format(weights_round) #False

model_de_save = 'GAN_de{}_norm'.format(save_round) #False
model_gen_save = 'GAN_gen{}_norm'.format(save_round) #False
