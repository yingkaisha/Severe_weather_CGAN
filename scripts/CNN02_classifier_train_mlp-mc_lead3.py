...
lead_name = lead2 #args['lead_name']
model_tag = 'base' #'vgg2' #args['model_tag']
sigma = 2
L_vec = 3
...
IND_TRAIN_lead = np.load('/glade/work/ksha/NCAR/IND_TRAIN_lead_{}{}{}{}.npy'.format(lead1, lead2, lead3, lead4_), allow_pickle=True)[()]
...
IND_VALID_lead = np.load('/glade/work/ksha/NCAR/IND_VALID_lead_{}{}{}{}.npy'.format(lead1, lead2, lead3, lead4_), allow_pickle=True)[()]
...
IND_TRAIN_lead = np.load('/glade/work/ksha/NCAR/IND_TRAIN_lead_{}{}{}{}_v4x.npy'.format(lead1, lead2, lead3, lead4_), allow_pickle=True)[()]
...
IND_VALID_lead = np.load('/glade/work/ksha/NCAR/IND_VALID_lead_{}{}{}{}_v4x.npy'.format(lead1, lead2, lead3, lead4_), allow_pickle=True)[()]
...
for i in range(L):
    ...
    TRAIN_Y_v3[i] = TRAIN_lead2_y_v3[ind_lead2_v3]
    
indx_train_v3, indy_train_v3, day_train_v3, lead_train_v3 = filename_to_loc(filename_train2_pick_v3)
...
for i in range(L):
    ...
    TRAIN_Y_v4x[i] = TRAIN_lead2_y_v4x[ind_lead2_v4x]
    
indx_train_v4x, indy_train_v4x, day_train_v4x, lead_train_v4x = filename_to_loc(filename_train2_pick_v4x)
...
for i in range(L):
    ...
    VALID_Y_v3[i] = VALID_lead2_y_v3[ind_lead2_v3]
    
indx_valid_v3, indy_valid_v3, day_valid_v3, lead_valid_v3 = filename_to_loc(filename_valid2_pick_v3)
...
for i in range(L):
    ...
    VALID_Y_v4x[i] = VALID_lead2_y_v4x[ind_lead2_v4x]
    
indx_valid_v4x, indy_valid_v4x, day_valid_v4x, lead_valid_v4x = filename_to_loc(filename_valid2_pick_v4x)
...
for i in range(L):
    ...
    VALID_Y[i] = VALID_lead2_y[ind_lead2]
    
VALID_VEC = np.concatenate((VALID_X_lead1[:, None, :], VALID_X_lead2[:, None, :], VALID_X_lead3[:, None, :],), axis=1)

# ================================================================== #
# extract location information

lon_norm, lat_norm, elev_norm = feature_extract(filename_valid2_pick, lon_80km, lon_minmax, lat_80km, lat_minmax, elev_80km, elev_max)
VALID_stn = np.concatenate((lon_norm[:, None], lat_norm[:, None]), axis=1)

indx_valid_v4, indy_valid_v4, day_valid_v4, lead_valid_v4 = filename_to_loc(filename_valid2_pick)
VALID_Y_v4_smooth = label_final_v4[day_valid_v4, indx_valid_v4, indy_valid_v4]
VALID_Y_v4_adjust = np.copy(VALID_Y_v4_smooth)

#ind_pick = np.random.randint(0, len(VALID_VEC), size=(187480,))

VALID_VEC_pick = VALID_VEC
VALID_stn_pick = VALID_stn
VALID_Y_pick = VALID_Y
...
def create_classif_head(L_vec, k_size=2, padding='same'):
    ...
    X = keras.layers.Dropout(0.05)(X, training=True)
